...
document.addEventListener("DOMContentLoaded", function () {
  ...
  // Get reference to the happy-new-year div
  var happyNewYearDiv = document.querySelector(".happy-new-year");
  var loadingScreen = document.querySelector(".start-screen");

  // Add click event listener to the button
  button.addEventListener("click", function () {
    // Show the happy-new-year div when button is clicked
    happyNewYearDiv.style.display = "block";
